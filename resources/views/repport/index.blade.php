        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Chiffre d'affaire sur une période</span></h5>
                ...
                <div class="users-list-filter">
                    <div class="card-panel">
                        <div class="row">
                            ...
                            <form action="{{ route('searchchiffreaffairebyperiod') }}" method="POST">
                                @csrf
                                                    ...
                                                    <table id="" class="display">
                                                        <thead>
                                                            <tr style="color:black">
                                                                <th style="text-align: left;">Chiffre d'affaire</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: left"><span> Du {{ $datedebut }} au {{ $datefin }} </span> </td>
                                                                <td style="text-align: right"><span>{{ $item->sum ?? 0 }}</span><span> f CFA </span> </td>
