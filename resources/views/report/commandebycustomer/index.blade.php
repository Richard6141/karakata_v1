        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Nombre de commande par client</span></h5>
                ...
                <div class="users-list-filter">
                    <div class="card-panel">
                        <div class="row">
                            ...
                            <form action="{{ route('searchcommandebycustomer') }}" method="POST">
                                @csrf
                                ...
                                <div class="col s12 m6 l3">
                                    <label style="color: black" for="users-list-status">Client</label>
                                    <div class="input-field">
