        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Nombre de commande par livreur</span></h5>
                ...
                <div class="users-list-filter">
                    <div class="card-panel">
                        <div class="row">
                            ...
                            <form action="{{ route('searchcommandebylivreur') }}" method="POST">
                                @csrf
                                ...
                                <div class="col s12 m6 l3">
                                    <label style="color: black" for="users-list-status">Livreur</label>
                                    <div class="input-field">
                                        <select class="browser-default" name="livreur" id="livreur">
                                            <option value=""></option>
                                                    ...
                                                    <table id="" class="display">
                                                        <thead>
                                                            <tr style="color:black">
                                                                <th style="text-align: left;">Livreur</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: left"><span>{{ $item->nom }} {{ $item->prenom }}</span></td>
