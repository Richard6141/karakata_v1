        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Modification d'un particulier</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="/">Acceuil</a>
                        </li>
                        <li class="breadcrumb-item"><a href="">Particulier</a>
                        </li>
                    ...
                    <div class="col s12 m12 l12">
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <form id="addForm" class="" action="{{ route('particular.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row" id="nom_div">
                                        <div class="input-field col s12">
                                            <input id="name" name="name" value="{{ $customer->particular->name }}" type="text" placeholder="" class="@error('name') is-invalid @enderror">
                                    ...
                                    <div class="row" id="prenom_div">
                                        <div class="input-field col s12">
                                            <input id="firstname" name="firstname" class="@error('firstname') is-invalid @enderror" type="text" placeholder="" value="{{ $customer->particular->firstname }}" type="text">
