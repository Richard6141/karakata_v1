        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Ajout d'un particulier</span></h5>
                    ...
                    <div class="col s12 m12 l12">
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <form id="addForm" class="" action="{{ route('particular.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row" id="nom_div">
                                        <div class="input-field col s12">
                                            <input id="name" value="{{old('name')}}" name="name" value="" type="text" placeholder="" class="@error('name') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="phone" name="phone" value="{{old('phone')}}" class="@error('phone') is-invalid @enderror" type="number" placeholder="" value="" type="number">
                                        ...
                                        <div class="input-field col s12">
                                            <input id="email" name="email" value="{{old('email')}}" class="@error('email') is-invalid @enderror" type="email" placeholder="" value="" type="email">
