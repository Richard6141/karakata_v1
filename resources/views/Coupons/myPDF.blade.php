    ...
    <table style="border: 3px solid #8EC741; width:400px; height:200px; border-radius:10px; margin-bottom: 10px; margin-right: auto; margin-left: auto;">
        <tr>
            <div>
                ...
                <div style="float: right; height: 30px; width: 30%; border-radius: 0 10px 0 20px; background-color: #F4681E; text-align: center; color: #fff; font-weight: bold; font-size:18px">{{ $coupon->coupon_value }} FCFA</div>
            </div>
        </tr>
        <tr>
        ...
        <table style="display: flex;">
            ...
            <table style="width: 50%; float: right">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td><input style="position: relative; top:9px" type="checkbox">
