                    ...
                    <div class="col s12 m12 l12">
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <form id="addForm" class="" action="{{ route('update.submissions', ['id' => $produit->id]) }}" method="POST">
                                    @csrf
                                    <div class="row margin">
                                        ...
                                        <div class="input-field col m6 s12">
                                            <input id="safetyStock" value="{{$produit->safety_stock}}" name="safetyStock" type="number" class="@error('safetyStock') is-invalid @enderror">
