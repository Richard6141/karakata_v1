                                    ...
                                    <div class="row margin">
                                        <div class="input-field col m6 s12">
                                            <select name="produit_id" id="produit_id">
                                                <option value=""></option>
                                                <option data-id="ajout">Ajouter un produit</option>
                                                @foreach($produits as $produit)
                                                <option data-id="{{$produit->id}}" value="{{$produit->id}}">{{$produit->label}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-field col s12">
                                            <input id="observations" name="observations" type="text"  class="@error('observations') is-invalid @enderror" value="{{ old('observations') }}">
                                            <label for="observations" class="center-align" style="color:black;">Observations :</label>
                                        ...
                                        <div class="input-field col m6 s12">
                                            <input data-id="{{$domaine->label}}" id="domaine_id" name="domaine_id" type="hidden" class="@error('domaine_id') is-invalid @enderror" value="{{$domaine->id}}">
                                        </div>
