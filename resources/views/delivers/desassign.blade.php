                                ...
                                <div class="col s12 m12 l12">
                                    <div id="Form-advance" class="card card card-default scrollspy">
                                        ...
                                        <form action="{{route('delivers.desassignorder', $delivers->id)}}" method="post">
                                            ...
                                            <div class="row">
                                                    <div class="col s10"><a href="{{route('delivers.assign', $delivers->id)}}" class="waves-effect waves-light btn gradient-45deg-deep-purple- z-depth-4 mt-2 mr-2 ml-2">Assigner</a>
                                                        <a href="{{route('delivers.desassign', $delivers->id)}}" style="background-color:green" class="waves-effect waves-light btn gradient-45deg-deep-purple- z-depth-4 mt-2 mr-2 ml-2 active">Désassigner</a>
