                                ...
                                <div class="col s12 m12 l12">
                                    <div id="Form-advance" class="card card card-default scrollspy">
                                        <div class="center" style="font-size: 2em;">
                                            <span>{{ $delivers->lastname}} {{ $delivers->firstname}}</span>
                                        </div>
                                        <form action="{{route('delivers.delivery_statut',  $delivers->id)}}" method="post">
                                            <div class="card-content">
                                                <div class="row">
                                                    <div class="col s10">
                                                        ...
                                                        <a href="{{route('delivers.delivery',  $delivers->id)}}" style="background-color:green" class="waves-effect waves-light btn gradient-45deg-deep-purple- z-depth-4 mt-2 mr-2 ml-2 active">Livraisons en cours</a>
                                                        <a href="{{route('delivers.deliveryrecover',  $delivers->id)}}" class="waves-effect waves-light btn gradient-45deg-deep-purple- z-depth-4 mt-2 mr-2 ml-2">Livraisons effectuées</a>
                                                    </div>
                                                    <div class="col s2">
                                                        <button id="modalBtnCommande" class="btn bcyan waves-effect waves-light right" style="margin-top:5%" type="submit">Livrer
