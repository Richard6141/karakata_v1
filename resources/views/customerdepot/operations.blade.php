        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Les Opérations du client</span></h5>
                ...
                <a href="{{route('suggestion.add',$id=0)}}" class="btn-floating  waves-effect waves-lig ht breadcrumbs-btn right mr-1 mb-1 modal-trigger btn-large">
                                                    ...
                                                    <table id="data-table-simple" class="display">
                                                        <thead>
                                                            <tr style="color:black">
                                                                ...
                                                                <th style="text-align: right">Mode de paiement</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: right"><span>{{ $item->date }}</span></td>
