    ...
    <div class="col s12">
        <div class="container">
            <div class="section">
                    ...
                    <div class="col s12 m12 l12">
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <form class="" action="{{ route('client.updateclient',$clients->id) }}" method="GET">
                @csrf

                <div class="row">
                    <div class="input-field col s12">
                        <input id="nom" name="nom" value="{{$clients->nom}}" type="text"
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="prenom" name="prenom" class="@error('prenom') is-invalid @enderror"
                            type="text" placeholder="prenom" value="{{$clients->prenom}}" type="text">
