<div id="particuliermodal" class="contact-compose-sidebar modal">
  <div class="card quill-wrapper">
    <div class="card-content pt-0">
      ...
      <!-- form start -->
      <form id="ParticulierAdd" class="edit-contact-item mb-5 mt-5" action="{{ route('particular.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            ...
            <input id="email" name="email" value="{{old('email')}}" type="email" class="@error('email') is-invalid @enderror">
      ...
      <div class="card-action pl-0 pr-0 right-align">
        <button type="submit" form="ParticulierAdd" class="btn-small waves-effect waves-light ">
          <span>Ajouter</span>
        </button>
