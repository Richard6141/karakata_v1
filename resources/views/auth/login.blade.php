...
<head>
    ...
    <title>KARAKATA Manager</title>
    <link rel="apple-touch-icon" href="{{ asset('logo/logo_karakata.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('logo/logo_karakata.png') }}">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <button type="submit" style="background-color: #F4681E"
                                        class="btn waves-effect waves-light border-round  col s12" style="font-weight: bold !important">Connexion</button>
                                </div>
                                <div class="center">
                                    <a href="{{ route('forgotPassword') }}">Mot de passe oublier !</a>
                                </div>
                            </div>
                            <div class="row">
