...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('accept/survey/{id}', [SurveyController::class, 'validate_survey'])->name('validate.survey');
    Route::get('view/survey/{id}', [SurveyController::class, 'view_survey'])->name('view.survey');
    Route::get('own/survey', [SurveyController::class, 'my_result'])->name('own.survey');
    Route::get('today/survey', [SurveyController::class, 'today_result'])->name('today.survey');
});
